...
let articles = [
	{
		...
		tagName: "healthy", 
		tag: "healthy living", 
		src: "signs-body-telling-enough.html"
	}, 
	{
	...
	}, 
	{
		...
		tagName: "healthy", 
		tag: "healthy living", 
		src: "10-wellness-tricks-enhance-mood.html"
	}, 
	{
	...
	}, 
	{
		...
		tagName: "yoga", 
		tag: "yoga", 
		src: "10-yoga-pilates-poses-to-ease-back-pain.html"
	}, 
	{
	...
	}, 
	{
		...
		tagName: "recipes", 
		tag: "recipes", 
		src: "juicing-recipes-healthy-lifestyle.html"
	}, 
	{
...
function articlesByTag(tagName) {
	...
	articles.filter(article => article.tagName === tagName || tagName === "all" ).forEach((article) => {
		g_html += "<a class=\"article\" href=\""+ article.src + "\">" +
